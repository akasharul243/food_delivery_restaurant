...
<body>
     ...
     <header>
        ...
        <a href="logout.jsp" style="position: absolute;right: 250px;top: 55px;text-decoration: none;color: yellow; font-size: 25px">Log out</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <a href="mycart.jsp" style="position: absolute;right: 100px;top: 55px;text-decoration: none;color: yellow;font-size: 25px">Bucket List</a>
